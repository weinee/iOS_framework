...
- (void)didClickBeginNoLink:(MLLinkLabel *)linkLabel;
- (void)didClickCancelNoLink:(MLLinkLabel *)linkLabel;
- (void)didClickEndNoLink:(MLLinkLabel *)linkLabel;
@end
...
@property (nonatomic, assign) BOOL allowNoLink;// 允许点击非连接部分
