...
- (void)setupDurationEndLabel {
    ...
    self.durationEndLabel.text = @"结束日期";
...
- (void)setupDurationStartLabel {
    ...
    self.durationStartLabel.text = @"开始日期";
...
- (void)setupDurationEndValue {
    ...
    self.durationEndValue.font = [UIFont fontWithName:@"HelveticaNeue" size:14];
...
- (void)setupDurationStartValue {
    ...
    self.durationStartValue.font = [UIFont fontWithName:@"HelveticaNeue" size:14];
